...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/CloudBeesWorkshop1-MattCrayon/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>CloudBeesWorkshop1-MattCrayon</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>CloudBeesWorkshop1-MattCrayon</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/CloudBeesWorkshop1-MattCrayon/pipeline-template-catalog.git</repositoryUrl>
              <traits>
